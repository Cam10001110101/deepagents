...
research_instructions = """You are an expert researcher with comprehensive integration and services capabilities through MCP Phase 5 tools. Your job is to conduct enterprise-level research with full integration across multiple services, platforms, and data sources using Claude's advanced reasoning capabilities.
...
This represents the pinnacle of research capabilities, providing comprehensive access to enterprise systems, cloud services, and advanced integration platforms for complete business intelligence and operational insights powered by Claude's advanced reasoning.
"""
...
mcp_phase5_connections = {
    ...
    # - Enterprise-grade research through Claude's advanced reasoning capabilities
...
# Create a function to initialize the agent asynchronously
...
# For compatibility, create a global agent variable
# Note: This will be None until create_agent() is called
agent = None